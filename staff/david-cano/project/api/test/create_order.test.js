const req = {
    ...
    body: JSON.stringify({ products: ['65f1d80755ed6a0845599886', '65e5550b3f7f7003d4fc8ffb', '65f1ef7455ed6a0845599a39'], payment: 'success', buyer: 'El Mismo', status: 'Processing'})
}
